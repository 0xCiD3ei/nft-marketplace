...
import NavItem from "src/components/shared/NavItem/NavItem";
import { ChevronDownIcon } from "@heroicons/react/outline";
import ButtonPrimary from "src/components/shared/Button/ButtonPrimary";
import TabFilters from "./TabFilters";
import { Transition } from "@headlessui/react";

const HeaderFilterSearchPage = ({ className = "mb-12", onActiveTab, tabs, tabActive, onRangePrice, onSaleStates, onSortOrderStates }) => {
  ...
  return (
    <div className={`flex flex-col relative ${className}`}>
      ...
      >
        ...
        {/*  onSaleStates={onSaleStates}*/}
        {/*  onSortOrderStates={onSortOrderStates}*/}
        {/*/>*/}
      </Transition>
    </div>
  );
