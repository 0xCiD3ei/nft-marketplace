...
import ButtonThird from "src/components/shared/Button/ButtonThird";
...
import Radio from "src/components/shared/Radio/Radio";
...
const TabFilters = () => {
  ...
  const [fileTypesState, setfileTypesState] = useState([]);
