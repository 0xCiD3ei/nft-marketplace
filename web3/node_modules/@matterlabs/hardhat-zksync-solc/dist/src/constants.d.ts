...
export declare const ZKSOLC_BIN_VERSION_INFO = "https://raw.githubusercontent.com/matter-labs/zksolc-bin/main";
...
export declare const COMPILER_VERSION_INFO_FILE_NOT_FOUND_ERROR = "Could not find zksolc compiler version info file. Please check your internet connection and try again.";
export declare const COMPILER_VERSION_INFO_FILE_DOWNLOAD_ERROR = "Could not download zksolc compiler version info file. Please check your internet connection and try again.";
