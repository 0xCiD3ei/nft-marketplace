...
exports.SOLCJS_EXECUTABLE_CODE = exports.COMPILING_INFO_MESSAGE = exports.COMPILER_BINARY_CORRUPTION_ERROR = exports.COMPILER_VERSION_WARNING = exports.COMPILER_VERSION_RANGE_ERROR = exports.COMPILER_VERSION_INFO_FILE_DOWNLOAD_ERROR = exports.COMPILER_VERSION_INFO_FILE_NOT_FOUND_ERROR = exports.DEFAULT_COMPILER_VERSION_INFO_CACHE_PERIOD = exports.ZKSOLC_COMPILERS_SELECTOR_MAP = exports.defaultZkSolcConfig = exports.ZKSOLC_BIN_VERSION_INFO = exports.ZKSOLC_BIN_REPOSITORY = exports.ZK_ARTIFACT_FORMAT_VERSION = exports.PLUGIN_NAME = void 0;
...
exports.ZKSOLC_BIN_VERSION_INFO = `https://raw.githubusercontent.com/matter-labs/zksolc-bin/main`;
...
exports.COMPILER_VERSION_INFO_FILE_NOT_FOUND_ERROR = 'Could not find zksolc compiler version info file. Please check your internet connection and try again.';
exports.COMPILER_VERSION_INFO_FILE_DOWNLOAD_ERROR = 'Could not download zksolc compiler version info file. Please check your internet connection and try again.';
const COMPILER_VERSION_RANGE_ERROR = (version, minVersion, latestVersion) => `Deprecated zksolc compiler version in hardhat config file (${version}). Please use versions ${minVersion} to ${latestVersion}.`;
